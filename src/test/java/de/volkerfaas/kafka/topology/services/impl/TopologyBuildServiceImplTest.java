...
class TopologyBuildServiceImplTest {
    ...
    void init() {
        ...
        SchemaFileServiceImpl schemaFileService = mock(SchemaFileServiceImpl.class);
        TopicServiceImpl topicService = mock(TopicServiceImpl.class);
        TopologyFileRepository topologyFileRepository = mock(TopologyFileRepository.class);
    ...
    class ListDomainsForUpdate {
        ...
        void testListDomainsForUpdate() {
            ...
            final Collection<Domain> domains = topologyBuildService.listDomainsForUpdate(topologyFiles, Collections.emptyList());
        ...
        void testListDomainsForUpdateSelectOne() {
            ...
            final Collection<Domain> domains = topologyBuildService.listDomainsForUpdate(topologyFiles, domainNames);
