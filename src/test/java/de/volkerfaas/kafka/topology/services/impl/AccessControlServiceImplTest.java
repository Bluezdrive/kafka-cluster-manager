...
class AccessControlServiceImplTest {
    ...
    class ListAclBindingsForVisibilityOrTopic {
        ...
        @Test
        @DisplayName("should return a set of AclBinding for a visibility when a principal is set as consumer")
        void testListVisibilityAclBindingsPrincipal() throws ExecutionException, InterruptedException {
            final ClusterConfiguration clusterConfiguration = new ClusterConfiguration("");
            doReturn(clusterConfiguration).when(kafkaClusterRepository).getClusterConfiguration();
        ...
        @Test
        @DisplayName("should return a set of AclBinding for a visibility when a domain name is set as consumer")
        void testListVisibilityAclBindingsDomainName() throws ExecutionException, InterruptedException {
            final ClusterConfiguration clusterConfiguration = new ClusterConfiguration("");
            doReturn(clusterConfiguration).when(kafkaClusterRepository).getClusterConfiguration();
        ...
        @Test
        @DisplayName("should return a set of AclBinding for a topic when a principal is set as consumer")
        void testListTopicAclBindingsPrincipal() throws ExecutionException, InterruptedException {
            final ClusterConfiguration clusterConfiguration = new ClusterConfiguration("");
            doReturn(clusterConfiguration).when(kafkaClusterRepository).getClusterConfiguration();
        ...
        @Test
        @DisplayName("should return a set of AclBinding for a topic when a domain name is set as consumer")
        void testListTopicAclBindingsDomainName() throws ExecutionException, InterruptedException {
            final ClusterConfiguration clusterConfiguration = new ClusterConfiguration("");
            doReturn(clusterConfiguration).when(kafkaClusterRepository).getClusterConfiguration();
