...
class SchemaFileServiceImplTest {
    ...
    class ListSchemaFilesByDomains {
        ...
        void testGetAllSchemaFilesOfDomains() {
            ...
            final Schema keySchema = new Schema(keySchemaFile, Schema.Type.AVRO, Schema.CompatibilityMode.FORWARD_TRANSITIVE);
            topic.setKeySchema(keySchema);
            final Schema valueSchema = new Schema(valueSchemaFile, Schema.Type.AVRO, Schema.CompatibilityMode.FORWARD_TRANSITIVE);
    ...
    class ListSchemaFilesByTopic {
        ...
        void testGetAllSchemaFilesOfTopic() {
            ...
            topic.setPrefix("de.volkerfaas.arc.public.");
            topic.setName("user_updated");
            final Schema keySchema = new Schema("events/de.volkerfaas.arc/de.volkerfaas.arc.public.user_updated-key.avsc", Schema.Type.AVRO, Schema.CompatibilityMode.FORWARD_TRANSITIVE);
            topic.setKeySchema(keySchema);
            final Schema valueSchema = new Schema("events/de.volkerfaas.arc/de.volkerfaas.arc.public.user_updated-value.avsc", Schema.Type.AVRO, Schema.CompatibilityMode.FORWARD_TRANSITIVE);
            topic.setValueSchema(valueSchema);
    ...
    class FindSchema {
        ...
        void testFindSchemaSuccess() throws IOException, RestClientException {
            ...
            assertEquals("events/de.volkerfaas.arc/de.volkerfaas.arc.public.user_updated-value.avsc", schema.getFile());
        }
