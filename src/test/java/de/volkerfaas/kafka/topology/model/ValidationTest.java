...
class ValidationTest {
    ...
    class TopicValidation {
        ...
        @DisplayName("should fail if the topic name does not match the specification")
        void testTopicValidationNameInvalid(String name) {
            ...
            topic.setDescription("This is the topic for the UserUpdated event.");
            topic.getClusters().add("test");
            final String subject = topic.getFullName() + "-value";
            ...
            assertThat(messages, containsInAnyOrder(
                    "must be either something like 'user_created', 'create_user' or 'users'",
                    "'" + subject + "' doesn't exist.",
                    "'" + subject + "' couldn't be parsed into a valid schema.",
                    "must be '(domain).(public|protected|private).(topic)-(key|value)'"));
        }
