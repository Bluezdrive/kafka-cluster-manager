...
class SchemaRegistryRepositoryImplTest {
    ...
    class DownloadSchemaFile {
        ...
        void testDownloadSchemaFile() throws IOException, RestClientException {
            ...
            try (MockedStatic<Files> filesMock = mockStatic(Files.class)) {
                ...
                final Schema schema = new Schema(schemaFile, null, null);
                final String schemaFilePath = schemaRegistryRepository.downloadSchema(schema, topologyDirectory);
        ...
        void testNotDownloadSchemaFile(String schemaFile) {
            final Schema schema = new Schema(schemaFile, Schema.Type.AVRO, Schema.CompatibilityMode.FORWARD_TRANSITIVE);
            final String schemaFilePath = schemaRegistryRepository.downloadSchema(schema, topologyDirectory);
    ...
    class UpdateCompatibility {
        ...
        void testUpdateCompatibilityEquals() throws IOException, RestClientException {
            ...
            final String schemaFile = "events/de.volkerfaas.test/" + subject + ".avsc";
            final Schema schema = new Schema(schemaFile, Schema.Type.AVRO, Schema.CompatibilityMode.valueOf(compatibility));
