...
public class KafkaClusterManager implements CommandLineRunner {
    ...
    public void run(String[] args) {
        ...
        try {
            if (restore) {
                ...
                final boolean writeDocumentationFile = arguments.containsOption(KafkaClusterManagerCommandLineArgument.WRITE_DOCUMENTATION_FILE);
                buildTopology(directory, domainNames, allowDeleteAcl, allowDeleteTopics, cluster, writeDocumentationFile);
            }
    ...
    public String getTopologyDirectory(final CommandLineArguments arguments) {
        final String directory = arguments.getOptionValue(KafkaClusterManagerCommandLineArgument.DIRECTORY, "topology");
    ...
    public void buildTopology(final String directory, final Collection<String> domainNames, final boolean allowDeleteAcl, final boolean allowDeleteTopics, final String cluster, final boolean writeDocumentationFile) throws InterruptedException, ExecutionException, IOException, IllegalTopologyException, IllegalCommandLineArgumentException {
