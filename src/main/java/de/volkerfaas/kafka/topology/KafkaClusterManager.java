...
public class KafkaClusterManager implements CommandLineRunner {
    ...
    public void buildTopology(final String directory, final Collection<String> domainNames, final boolean allowDeleteAcl, final boolean allowDeleteTopics, final String cluster, final boolean writeDocumentationFile) throws InterruptedException, ExecutionException, IOException {
