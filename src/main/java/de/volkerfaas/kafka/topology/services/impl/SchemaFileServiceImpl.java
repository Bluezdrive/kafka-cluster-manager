...
public class SchemaFileServiceImpl implements SchemaFileService {
    ...
    @Override
    public Set<Path> listSchemaFilesByDomains(Collection<Domain> domains) {
    ...
    public Set<Path> listSchemaFilesByTopic(Topic topic) {
        final Set<Path> schemaFiles = new HashSet<>();
