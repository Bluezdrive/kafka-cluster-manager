...
@Service
public class TopologyBuildServiceImpl implements TopologyBuildService {

    private static final Logger LOGGER = LoggerFactory.getLogger(TopologyBuildServiceImpl.class);
    ...
    @Autowired
    public TopologyBuildServiceImpl(final AccessControlService accessControlService, final SchemaFileService schemaFileService, final TopicService topicService, final TopologyValuesService topologyValuesService, final TopologyFileRepository topologyFileRepository, final Validator validator) {
    ...
    @Override
    public Collection<Domain> listDomainsForUpdate(final Collection<TopologyFile> topologies, final Collection<String> domainNames) {
