...
public enum KafkaClusterManagerCommandLineArgument implements CommandLineArgument {
    ...
    DIRECTORY("directory", false, Collections.emptyList(), Collections.emptyList()),
    DOMAIN("domain", false, Collections.emptyList(), Collections.emptyList()),
    CLUSTER("cluster", true, Collections.emptyList(), Collections.emptyList()),
    ...
    WRITE_DOCUMENTATION_FILE("write-documentation-file", false, Collections.emptyList(), Collections.emptyList()),
